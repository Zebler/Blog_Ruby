class Champion <ActiveRecord::Base
  ...
  has_many_attached :slash_arts

  attr_accessor :Champ_name, :Champ_title, :Resource_type, :Price, :Champ_stat_id, :Champ_ms, :Champ_attack_range, :Champ_AS_id, :Champ_Ability_Kit_id

  @@no_of_Champion = 0
  def initialize( champ_name, champ_title, resource_type, price, champ_stats_id, champ_ms, champ_attack_range, champ_AS_id, champ_Ability_Kit_id)
